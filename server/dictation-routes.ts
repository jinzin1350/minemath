  ...
  try {
    ...
    const responseData = {
      ...
      dailyHistory: dailyHistory.map(day => ({
        date: day.date,
        totalGames: Number(day.totalGames),
        totalScore: Number(day.totalScore) || 0,
        totalWords: Number(day.totalWords) || 0,
        totalCorrect: Number(day.totalCorrect) || 0,
        accuracy: Math.round(Number(day.avgAccuracy) || 0),
        bestLevel: Number(day.bestLevel) || 1,
      })),
      modeStats: modeStats.map(mode => ({
        gameMode: mode.gameMode,
        totalGames: Number(mode.totalGames),
        totalScore: Number(mode.totalScore) || 0,
        totalWords: Number(mode.totalWords) || 0,
        totalCorrect: Number(mode.totalCorrect) || 0,
        accuracy: Math.round(Number(mode.avgAccuracy) || 0),
      })),
      monthlySummary: monthlySummary[0] ? {
        totalGames: Number(monthlySummary[0].totalGames),
        totalScore: Number(monthlySummary[0].totalScore) || 0,
        totalWords: Number(monthlySummary[0].totalWords) || 0,
        totalCorrect: Number(monthlySummary[0].totalCorrect) || 0,
        accuracy: Math.round(Number(monthlySummary[0].avgAccuracy) || 0),
        bestLevel: Number(monthlySummary[0].bestLevel) || 1,
        activeDays: Number(monthlySummary[0].uniqueDays) || 0,
      } : {
        totalGames: 0,
        totalScore: 0,
        totalWords: 0,
